package ir.mahfa.urlshortener.base.exception.enums;
...
public enum ErrorCode {
    ...
    MAXIMUM_REACHED(2001, HttpStatus.BAD_REQUEST, "maximum reached"),
    DUPLICATE_KEY(2002, HttpStatus.BAD_REQUEST, "this url exist in your list"),
